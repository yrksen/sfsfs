  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-700 border-2 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors text-xs font-medium dark:text-white"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-700 border-2 dark:border-gray-600 rounded-lg shadow-lg z-50 overflow-hidden">
