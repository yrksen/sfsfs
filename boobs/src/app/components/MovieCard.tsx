...
export function MovieCard({ movie, onClick, onDelete }: MovieCardProps) {
  ...
  return (
    <div 
      className="flex flex-col rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-all duration-200 cursor-pointer relative group border border-gray-200/50 dark:border-gray-700 bg-[#D3D3D3] dark:bg-gray-800"
